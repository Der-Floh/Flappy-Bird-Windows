...
{
    public bool UnsavedChanges { get; set { field = value; SaveButton.Enabled = value; } }
    ...
    public ConfigForm(IConfigService configService, IOptions<GameplayConfig> gameplayOptions, IOptions<ControlsConfig> controlsOptions, IOptions<ProgramConfig> programOptions)
    {
        InitializeComponent();
        ...
        _configObjects = [programConfig, gameplayOptions.Value, controlsOptions.Value];
        GenerateControls();
    }
    ...
    {
        UnsavedChanges = !_configService.Save();
    }
